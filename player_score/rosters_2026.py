rosters_2026 = {   'Spain': {   'Unai Simón Mendibil': {'club': 'Athletic Club', 'age': 28},
                 'Sergio Ramos García': {'club': 'unknown', 'age': 38},
    ...
    'Argentina': {   'Damián Emiliano Martínez': {'club': 'Aston Villa', 'age': 33},
    ...
    'Portugal': {   'Diogo Meireles Costa': {'club': 'Porto', 'age': 26},
                    ...
                    'João Maria Lobo Alves Palhinha Gonçalves': {   'club': 'Bayern Munich',
                                                                    'age': 30},
    ...
    'Uruguay': {   'Sergio Rochet Álvarez': {'club': 'Internacional', 'age': 32},
    ...
    'Colombia': {   'David Ospina Ramírez': {'club': 'Atlético Nacional', 'age': 37},
    ...
    'DR Congo': {   'Chancel Mbemba Mangulu': {'club': 'Marseille', 'age': 31},
                    'Yoane Wissa': {'club': 'Brentford', 'age': 29},
                    "Théo Bongonda Mbul'Anay Itoke Mbando Pozzi": {   'club': 'Spartak Moscow',
                                                                      'age': 30},
                    'Samuel Essende': {'club': 'Augsburg', 'age': 28},
                    'Noah Sadiki': {'club': 'Union SG', 'age': 21}},
    'Côte d’Ivoire': {   'Franck Yannick Kessié': {'club': 'Al-Ahli', 'age': 29},
    ...
    'Cape Verde': {   'Ryan Isaac Mendes da Graça': {'club': 'Fatih Karagümrük', 'age': 36},
    ...
    'Egypt': {   'Mohamed Salah': {'club': 'Liverpool', 'age': 33},
    ...
    'South Africa': {   'Ronwen Williams': {'club': 'Mamelodi Sundowns', 'age': 34},
    ...
    'Mali': {   'Yves Bissouma': {'club': 'Tottenham Hotspur', 'age': 29},
    ...
    'Cameroon': {   'André Onana': {'club': 'Manchester United', 'age': 29},
    ...
    'Czech Republic': {   'Patrik Schick': {'club': 'Bayer Leverkusen', 'age': 30},
    ...
    'Albania': {   'Armando Broja': {'club': 'Everton', 'age': 24},
    ...
    'Denmark': {   'Rasmus Winther Højlund': {'club': 'Manchester United', 'age': 23},
    ...
    'Ukraine': {   'Andriy Lunin': {'club': 'Real Madrid', 'age': 27},
    ...
    'South Korea': {   'Heung-Min Son': {'club': 'Tottenham Hotspur', 'age': 33},
    ...
    'Georgia': {   'Khvicha Kvaratskhelia': {'club': 'Napoli', 'age': 25},
                   'Georges Mikautadze': {'club': 'Lyon', 'age': 25},
                   'Giorgi Mamardashvili': {'club': 'Liverpool', 'age': 25},
                   'Otar Kiteishvili': {'club': 'Sturm Graz', 'age': 29},
                   'Budu Zivzivadze': {'club': 'Karlsruher SC', 'age': 32}},
    'Iran': {   'Mehdi Taremi': {'club': 'Inter Milan', 'age': 33},
    ...
    'Saudi Arabia': {   'Salem Mohammed Al Dawsari': {'club': 'Al-Hilal', 'age': 34},
    ...
    'Romania': {   'Radu Drăgușin': {'club': 'Tottenham Hotspur', 'age': 24},
    ...
    'Hungary': {   'Dominik Szoboszlai': {'club': 'Liverpool', 'age': 25},
    ...
    'Slovenia': {   'Benjamin Šeško': {'club': 'RB Leipzig', 'age': 22},
                    'Jan Oblak': {'club': 'Atlético Madrid', 'age': 33},
                    'Adam Gnezda Čerin': {'club': 'Panathinaikos', 'age': 26},
                    'Jaka Bijol': {'club': 'Udinese', 'age': 27},
                    'Timi Elšnik': {'club': 'Red Star Belgrade', 'age': 27}},
    'Qatar': {   'Akram Hassan Afif': {'club': 'Al-Sadd', 'age': 29},
