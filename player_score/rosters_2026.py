...
rosters_2026 = {
    ...
    'DR Congo': {
        'Chancel Mbemba Mangulu': {'club': 'Marseille', 'age': 31},
        'Yoane Wissa': {'club': 'Brentford', 'age': 29},
        "Théo Bongonda Mbul'Anay Itoke Mbando Pozzi": {'club': 'Spartak Moscow', 'age': 30},
        'Samuel Essende': {'club': 'Augsburg', 'age': 28},
        'Noah Sadiki': {'club': 'Union SG', 'age': 21},
        # ⚠ DR Congo: currently in Inter-confederation playoff (March 26 & 31)
        # DR Congo gets a bye to the final on March 31 — qualifier still TBD
    },

    'Côte d\'Ivoire': {
        'Franck Yannick Kessié': {'club': 'Al-Ahli', 'age': 29},
        'Sébastien Haller': {'club': 'Leganés', 'age': 31},
        'Simon Adingra': {'club': 'Brighton', 'age': 24},
        'Amad Diallo Traoré': {'club': 'Manchester United', 'age': 23},
        'Odilon Kossonou': {'club': 'Atalanta', 'age': 25},
    },

    'Cape Verde': {
        'Ryan Isaac Mendes da Graça': {'club': 'Fatih Karagümrük', 'age': 36},
        'Jovane Cabral': {'club': 'Estrela Amadora', 'age': 27},
        'Jamiro Gregory Monteiro Alvarenga': {'club': 'Gaziantep', 'age': 32},
        'Logan Costa': {'club': 'Villarreal', 'age': 24},
        'Bruno Miguel Rivotti Varela': {'club': 'Vitória Guimarães', 'age': 31},
    },

    'Egypt': {
        'Mohamed Salah': {'club': 'Liverpool', 'age': 33},
        'Omar Marmoush': {'club': 'Eintracht Frankfurt', 'age': 27},
        # ⚠ NOTE: Omar Marmoush — confirm current club (was linked with several clubs)
        'Mostafa Mohamed Ahmed Abdallah': {'club': 'Nantes', 'age': 28},
        # ⚠ TOP_100 rank 9 lists him at Liverpool — that is WRONG; he's at Nantes in roster
    ...
    'Mali': {
        ...
        'Amadou Haïdara': {'club': 'RB Leipzig', 'age': 28},
        'Kamory Doumbia': {'club': 'Brest', 'age': 23},
        'El Bilal Toure': {'club': 'Stuttgart', 'age': 24},
        'Hamari Traoré': {'club': 'Real Sociedad', 'age': 34},
    },

    'Cameroon': {
        'André Onana': {'club': 'Manchester United', 'age': 29},
        'Bryan Mbeumo': {'club': 'Brentford', 'age': 26},
        'Vincent Paté Aboubakar': {'club': 'Hatayspor', 'age': 34},
        'Carlos Baleba': {'club': 'Brighton', 'age': 22},
        'André-Frank Zambo Anguissa': {'club': 'Napoli', 'age': 30},
    },

    'Czech Republic': {
        # ⚠ QUALIFICATION STATUS: IN UEFA PLAYOFF PATH D (semifinal TODAY, March 26)
    ...
    'Denmark': {
        ...
        'Pierre-Emile Højbjerg': {'club': 'Marseille', 'age': 30},
        'Christian Dannemann Eriksen': {'club': 'Manchester United', 'age': 34, 'position_override': 'CM'},
        'Joachim Andersen': {'club': 'Fulham', 'age': 29},
        'Morten Hjulmand': {'club': 'Sporting CP', 'age': 26},
    },

    'Ukraine': {
        # ⚠ QUALIFICATION STATUS: IN UEFA PLAYOFF PATH B (semifinal TODAY, March 26)
        # Ukraine play Sweden today (at Valencia, Spain — neutral venue due to war)
        'Andriy Lunin': {'club': 'Real Madrid', 'age': 27},
        'Mykhailo Mudryk': {'club': 'Chelsea', 'age': 25},
        # ⚠ NOTE: Mudryk serving a doping ban — eligibility at WC needs confirmation
    ...
    'South Korea': {
        ...
        'Kang-In Lee': {'club': 'Paris Saint-Germain', 'age': 25},
        'Hee-Chan Hwang': {'club': 'Wolves', 'age': 30},
        'In-Beom Hwang': {'club': 'Feyenoord', 'age': 29},
    },
    ...
    'Saudi Arabia': {
        ...
        'Saud Abdullah Abdul Hamid': {'club': 'Roma', 'age': 26},
    ...
    'Hungary': {
        ...
        'Willi Orban': {'club': 'RB Leipzig', 'age': 33},
    },


    'Qatar': {
        'Akram Hassan Afif': {'club': 'Al-Sadd', 'age': 29},
