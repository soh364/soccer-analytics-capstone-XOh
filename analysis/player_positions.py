POSITION_OVERRIDES = {
    # Misclassified positions from the data
    ...
    'Bruno Guimarães Rodriguez Moura': 'Center Defensive Midfield',
    'Aurélien Djani Tchouaméni':    'Center Defensive Midfield',
    'Exequiel Alejandro Palacios':  'Center Midfield',
}